...
//@lei start 2018.1.12
	////////////////////////////////////////user define parameter1
	public boolean isDataIC = false;
	public boolean isTimeout = false;

	//start time of cloudlet used to simulate TIMEOUT
...
//@lei start 2018.1.12
////////////////////////////////////////timeout simulation, user define1
startTime = CloudSim.clock();//initial submit time of the cloudlet		
////////////////////////////////////////timeout simulation, user define2
//@lei end 2018.1.12
	}
...
//@lei start 2018.1.12
//////////////////////////////////////data inconsistency simulation, user define1


/**
* data inconsistency simulation.
* 
* @return 1:the data inconsistency happen. 0:not happen
*/
	public boolean DatainconsistencySimulation() {
		if (Config.isDataICHappen)// data inconsistency happen or not. 1:happen, 0:nohappen
		{
			Random r2 = new Random();
			double prob = (double) r2.nextInt(10000) / 10000;
			System.out.println("cloudletId=" + cloudletId + " prob=" + prob);
			if (Config.probOfIC >= prob)// data inconsistency happen, remove this cloudlet
			{
				return true;
			}
...
/**
 * Timeout simulation.
 * @param TempcloudScheduler: the scheduler runing on the current VM 
 */

	public void TimeoutSimulation(double timeoutClock) {
//		System.out.println("\ncloudletId="+getCloudletId()+" timeoutClock="+timeoutClock);
		if(CloudSim.clock() > timeoutClock) {
			this.isTimeout = true;
		}
		
//		double waitingTime = this.getWaitingTime();
//		double tatolTime = this.getFinishTime()-this.getExecStartTime();
//		System.out.println("\ncloudletId="+getCloudletId()+" waitingTime="+waitingTime+" submissionTime="+this.getSubmissionTime()+" startExeTime="+this.getExecStartTime()+" finishTime="+this.getFinishTime());
//		if(waitingTime > Config.timeoutThreshold) {
//			this.isTimeout = true;
//		}
	}
//////////////////////////////////////Timeout simulation, user define2
